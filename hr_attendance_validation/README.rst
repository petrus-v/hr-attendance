...
- Ensure employee ``working hours`` (the week ressource calendar) are
  properly set.

- Check bellow the ``Weekly Attendance Validation`` boolean on the same
  employee form to use validation sheet or not for this employee.
...
- Split this module:
  ...
  - hr_overtime_view: to display overtime data and allow analyisis
  - hr_overtime_credit: to allow user get overtime by credit and display
    the amount of negative overtime

- display overtime in employee dashboard
